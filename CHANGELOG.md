...
> ### ยังต้องทำทันที: push แล้ว redeploy
>
> การแก้ทั้งหมดในรอบนี้อยู่ในไฟล์ของรีโปเท่านั้น **ลิงก์ Streamlit สาธารณะจะยังขึ้น `ImportError` จนกว่าจะ push ขึ้น GitHub แล้ว redeploy**
>
> ต้อง push ให้ครบทั้ง **`requirements.txt`** และ **`packages.txt`** — ขาดไฟล์ใดไฟล์หนึ่งแอปอาจยังบูตไม่ขึ้น
> หลัง deploy แล้วถ้ายังขึ้น error เดิม ให้เข้า Manage app → **Reboot** เพราะบางทีมันใช้ environment ที่ cache ไว้
>
> **อย่าเชื่อว่า deploy สำเร็จจนกว่าจะเปิดลิงก์เห็นหน้าแอปจริงด้วยตา** และเช็กซ้ำอีกครั้งก่อนส่งงาน
> เพราะ Streamlit Cloud จะสั่งแอปหลับเองเมื่อไม่มีคนเข้าสักพัก (จะขึ้นหน้า Zzzz ให้กดปลุก)
...
*บันทึกนี้เขียนตอนแก้ F-01 ถึง F-08 เสร็จ · หมายเลข F-xx อ้างอิงรายงานตรวจโค้ดฉบับเต็มที่ทำไว้ก่อนแก้*
